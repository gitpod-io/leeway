...
type RemoteCache interface {
	...
	Download(ctx context.Context, dst Cache, pkgs []*Package) error
	...
	Upload(ctx context.Context, src Cache, pkgs []*Package) error
}
...
// ExistingPackages returns existing cached build artifacts in the remote cache
func (NoRemoteCache) ExistingPackages(ctx context.Context, pkgs []*Package) (map[*Package]struct{}, error) {
	return map[*Package]struct{}{}, nil
}

// Download makes a best-effort attempt at downloading previously cached build artifacts
func (NoRemoteCache) Download(ctx context.Context, dst Cache, pkgs []*Package) error {
	return nil
}

// Upload makes a best effort to upload the build arfitacts to a remote cache
func (NoRemoteCache) Upload(ctx context.Context, src Cache, pkgs []*Package) error {
	return nil
}
...
// ExistingPackages returns existing cached build artifacts in the remote cache
func (rs GSUtilRemoteCache) ExistingPackages(ctx context.Context, pkgs []*Package) (map[*Package]struct{}, error) {
...
// Download makes a best-effort attempt at downloading previously cached build artifacts
func (rs GSUtilRemoteCache) Download(ctx context.Context, dst Cache, pkgs []*Package) error {
...
// Upload makes a best effort to upload the build arfitacts to a remote cache
func (rs GSUtilRemoteCache) Upload(ctx context.Context, src Cache, pkgs []*Package) error {
